...
@MapperScan(basePackages = "com.example.springboot-demo.*repository.")
...
//                "classpath:mybatis-config.xml")));
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.example.springboot-demo.*.model"); // @Alias 사용할 패키지 명
